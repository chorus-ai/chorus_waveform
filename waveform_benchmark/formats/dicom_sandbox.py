# %%
import waveform_benchmark.formats.dcm_waveform_reader as dwh
...
import psutil
import time
import dcm_waveform_reader as dwh

f = '/mnt/c/Users/tcp19/Downloads/Compressed/test_waveform.dcm'
# get the waveform sequence
seqs = dwh.get_waveform_sequence(open, f)
gc.collect()
print('Read with deferred:  RAM memory Bytes used:', psutil.virtual_memory()[3])
